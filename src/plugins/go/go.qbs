...
QtcPlugin {
    ...
    Group {
        ...
        files: [
            ...
            "exprtyperesolver.cpp", "exprtyperesolver.h",
            "gochecksymbols.cpp", "gochecksymbols.h",
            "gocodemodelmanager.cpp", "gocodemodelmanager.h",
            "gocompletionassistvisitor.cpp", "gocompletionassistvisitor.h",
            "goeditordocumenthandle.cpp", "goeditordocumenthandle.h",
            "goeditordocumentparser.cpp", "goeditordocumentparser.h",
            "goeditordocumentprocessor.cpp", "goeditordocumentprocessor.h",
            "goeditoroutline.cpp", "goeditoroutline.h",
            "gooverviewmodel.cpp", "gooverviewmodel.h",
            "gopackage.cpp", "gopackage.h",
            "gopackagedirindexer.cpp", "gopackagedirindexer.h",
            "gopackageimporter.cpp", "gopackageimporter.h",
            "gopackagetypes.cpp", "gopackagetypes.h",
            "gosemantichighlighter.cpp", "gosemantichighlighter.h",
            "gosnapshot.cpp", "gosnapshot.h",
            "gosource.cpp", "gosource.h",
            "literals.cpp", "literals.h",
            "literaltable.h",
            "lookupcontext.h",
            "memorypool.cpp", "memorypool.h",
            "methodsscope.cpp", "methodsscope.h",
            "parser.cpp", "parser.h",
            "scanner.cpp", "scanner.h",
            "scope.cpp", "scope.h",
            "symbol.cpp", "symbol.h",
            "symboltable.cpp", "symboltable.h",
            "symbolundercursor.cpp", "symbolundercursor.h",
            "token.cpp", "token.h",
